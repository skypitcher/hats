...
The key idea of this paper is to train the network towards the optimal heuristic. The associated paper has been submitted to Nature Machine Intelligence. You can check the [Preprint](https://arxiv.org/abs/2101.02420) online if you are interested.
